/**
  ******************************************************************************
  * @file           : oledfont.h
  * @brief          : OLED font data header file
  ******************************************************************************
  * @attention
  *
  * Copyright (c) Zhejiang University of Technology 2025-2035
  * All rights reserved.
  *
  * This file is for learning only, do not modify without permission;
  * Source: https://gitee.com/NEagle
  * Modified: 2025/12/06
  * Version: V1.0
  *
  ******************************************************************************
...
/**
  * @brief  Character data storage format
  * @details Character data stored bitwise, each bit corresponds to an OLED pixel
  *          MSB First (Most Significant Bit first) ordering
  *          Every 8 bits correspond to one row of OLED pixels
  *
  *      B0 B0                  B0 B0
  *      B1 B1                  B1 B1
  *      B2 B2                  B2 B2
  *      B3 B3  ------------->  B3 B3 --  New format: Bit7 first (MSB First)
  *      B4 B4                  B4 B4  |
  *      B5 B5                  B5 B5  |
  *      B6 B6                  B6 B6  |
  *      B7 B7                  B7 B7  v
  ...
  *      B1 B1                  B1 B1
  *      B2 B2                  B2 B2
  *      --> B3 B3  ------------->  B3 B3  Old format: Bit0 first (LSB First)
  *      B4 B4                  B4 B4
  *      B5 B5                  B5 B5
  *      B6 B6                  B6 B6
  *      B7 B7                  B7 B7
  *
  *  This driver uses new format (MSB First)
  */

#define OLED_CHN_CHAR_WIDTH    3    // UTF-8 encoding uses 3 bytes, GB2312 uses 2 bytes

/**
  * @brief  Chinese font structure definition
  * @details Stores dot matrix data for Chinese characters
  */
typedef struct {
    char Index[OLED_CHN_CHAR_WIDTH + 1];    // 字符索引（内码）
    unsigned char Data[32];                 // 点阵数据（16x16点阵需32字节）
} ChineseCell_t;
...
const unsigned char OLED_F8x16[][16] = {
    ...
    0x00,0xE0,0x10,0x88,0x88,0x18,0x00,0x00,0x00,0x0F,0x11,0x20,0x20,0x20,0x11,0x0E,0x00,// 6 22
    ...
    0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,// | 92
